...
### [ ] Phase 3 — State-machine-driven long-running goals
- **文件**：`swaybot/coordinator.py`、`swaybot/api.py`、`tests/test_coordinator.py`
- **状态**：进行中。给 `GoalCoordinator` 引入显式状态机与 resume，子任务通过 `Scheduler` 调度，API 暴露 goal CRUD。
